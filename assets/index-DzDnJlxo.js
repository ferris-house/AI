 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var iv;function US(){if(iv)return ht;iv=1;var s=Symbol.for("react.transitional.element"),e=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),f=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),v=Symbol.for("react.activity"),y=Symbol.iterator;function E(M){return M===null||typeof M!="object"?null:(M=y&&M[y]||M["@@iterator"],typeof M=="function"?M:null)}var b={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},A=Object.assign,x={};function _(M,k,ee){this.props=M,this.context=k,this.refs=x,this.updater=ee||b}_.prototype.isReactComponent={},_.prototype.setState=function(M,k){if(typeof M!="object"&&typeof M!="function"&&M!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,M,k,"setState")},_.prototype.forceUpdate=function(M){this.updater.enqueueForceUpdate(this,M,"forceUpdate")};function O(){}O.prototype=_.prototype;function P(M,k,ee){this.props=M,this.context=k,this.refs=x,this.updater=ee||b}var C=P.prototype=new O;C.constructor=P,A(C,_.prototype),C.isPureReactComponent=!0;var H=Array.isArray;function W(){}var z={H:null,A:null,T:null,S:null},K=Object.prototype.hasOwnProperty;function U(M,k,ee){var le=ee.ref;return{$$typeof:s,type:M,key:k,ref:le!==void 0?le:null,props:ee}}function L(M,k){return U(M.type,k,M.props)}function Y(M){return typeof M=="object"&&M!==null&&M.$$typeof===s}function re(M){var k={"=":"=0",":":"=2"};return"$"+M.replace(/[=:]/g,function(ee){return k[ee]})}var ce=/\/+/g;function xe(M,k){return typeof M=="object"&&M!==null&&M.key!=null?re(""+M.key):k.toString(36)}function ue(M){switch(M.status){case"fulfilled":return M.value;case"rejected":throw M.reason;default:switch(typeof M.status=="string"?M.then(W,W):(M.status="pending",M.then(function(k){M.status==="pending"&&(M.status="fulfilled",M.value=k)},function(k){M.status==="pending"&&(M.status="rejected",M.reason=k)})),M.status){case"fulfilled":return M.value;case"rejected":throw M.reason}}throw M}function F(M,k,ee,le,se){var T=typeof M;(T==="undefined"||T==="boolean")&&(M=null);var I=!1;if(M===null)I=!0;else switch(T){case"bigint":case"string":case"number":I=!0;break;case"object":switch(M.$$typeof){case s:case e:I=!0;break;case g:return I=M._init,F(I(M._payload),k,ee,le,se)}}if(I)return se=se(M),I=le===""?"."+xe(M,0):le,H(se)?(ee="",I!=null&&(ee=I.replace(ce,"$&/")+"/"),F(se,k,ee,"",function(Ee){return Ee})):se!=null&&(Y(se)&&(se=L(se,ee+(se.key==null||M&&M.key===se.key?"":(""+se.key).replace(ce,"$&/")+"/")+I)),k.push(se)),1;I=0;var te=le===""?".":le+":";if(H(M))for(var oe=0;oe<M.length;oe++)le=M[oe],T=te+xe(le,oe),I+=F(le,k,ee,T,se);else if(oe=E(M),typeof oe=="function")for(M=oe.call(M),oe=0;!(le=M.next()).done;)le=le.value,T=te+xe(le,oe++),I+=F(le,k,ee,T,se);else if(T==="object"){if(typeof M.then=="function")return F(ue(M),k,ee,le,se);throw k=String(M),Error("Objects are not valid as a React child (found: "+(k==="[object Object]"?"object with keys {"+Object.keys(M).join(", ")+"}":k)+"). If you meant to render a collection of children, use an array instead.")}return I}function Q(M,k,ee){if(M==null)return M;var le=[],se=0;return F(M,le,"","",function(T){return k.call(ee,T,se++)}),le}function J(M){if(M._status===-1){var k=M._result;k=k(),k.then(function(ee){(M._status===0||M._status===-1)&&(M._status=1,M._result=ee)},function(ee){(M._status===0||M._status===-1)&&(M._status=2,M._result=ee)}),M._status===-1&&(M._status=0,M._result=k)}if(M._status===1)return M._result.default;throw M._result}var X=typeof reportError=="function"?reportError:function(M){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var k=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof M=="object"&&M!==null&&typeof M.message=="string"?String(M.message):String(M),error:M});if(!window.dispatchEvent(k))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",M);return}console.error(M)},N={map:Q,forEach:function(M,k,ee){Q(M,function(){k.apply(this,arguments)},ee)},count:function(M){var k=0;return Q(M,function(){k++}),k},toArray:function(M){return Q(M,function(k){return k})||[]},only:function(M){if(!Y(M))throw Error("React.Children.only expected to receive a single React element child.");return M}};return ht.Activity=v,ht.Children=N,ht.Component=_,ht.Fragment=i,ht.Profiler=l,ht.PureComponent=P,ht.StrictMode=a,ht.Suspense=p,ht.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=z,ht.__COMPILER_RUNTIME={__proto__:null,c:function(M){return z.H.useMemoCache(M)}},ht.cache=function(M){return function(){return M.apply(null,arguments)}},ht.cacheSignal=function(){return null},ht.cloneElement=function(M,k,ee){if(M==null)throw Error("The argument must be a React element, but you passed "+M+".");var le=A({},M.props),se=M.key;if(k!=null)for(T in k.key!==void 0&&(se=""+k.key),k)!K.call(k,T)||T==="key"||T==="__self"||T==="__source"||T==="ref"&&k.ref===void 0||(le[T]=k[T]);var T=arguments.length-2;if(T===1)le.children=ee;else if(1<T){for(var I=Array(T),te=0;te<T;te++)I[te]=arguments[te+2];le.children=I}return U(M.type,se,le)},ht.createContext=function(M){return M={$$typeof:f,_currentValue:M,_currentValue2:M,_threadCount:0,Provider:null,Consumer:null},M.Provider=M,M.Consumer={$$typeof:c,_context:M},M},ht.createElement=function(M,k,ee){var le,se={},T=null;if(k!=null)for(le in k.key!==void 0&&(T=""+k.key),k)K.call(k,le)&&le!=="key"&&le!=="__self"&&le!=="__source"&&(se[le]=k[le]);var I=arguments.length-2;if(I===1)se.children=ee;else if(1<I){for(var te=Array(I),oe=0;oe<I;oe++)te[oe]=arguments[oe+2];se.children=te}if(M&&M.defaultProps)for(le in I=M.defaultProps,I)se[le]===void 0&&(se[le]=I[le]);return U(M,T,se)},ht.createRef=function(){return{current:null}},ht.forwardRef=function(M){return{$$typeof:d,render:M}},ht.isValidElement=Y,ht.lazy=function(M){return{$$typeof:g,_payload:{_status:-1,_result:M},_init:J}},ht.memo=function(M,k){return{$$typeof:m,type:M,compare:k===void 0?null:k}},ht.startTransition=function(M){var k=z.T,ee={};z.T=ee;try{var le=M(),se=z.S;se!==null&&se(ee,le),typeof le=="object"&&le!==null&&typeof le.then=="function"&&le.then(W,X)}catch(T){X(T)}finally{k!==null&&ee.types!==null&&(k.types=ee.types),z.T=k}},ht.unstable_useCacheRefresh=function(){return z.H.useCacheRefresh()},ht.use=function(M){return z.H.use(M)},ht.useActionState=function(M,k,ee){return z.H.useActionState(M,k,ee)},ht.useCallback=function(M,k){return z.H.useCallback(M,k)},ht.useContext=function(M){return z.H.useContext(M)},ht.useDebugValue=function(){},ht.useDeferredValue=function(M,k){return z.H.useDeferredValue(M,k)},ht.useEffect=function(M,k){return z.H.useEffect(M,k)},ht.useEffectEvent=function(M){return z.H.useEffectEvent(M)},ht.useId=function(){return z.H.useId()},ht.useImperativeHandle=function(M,k,ee){return z.H.useImperativeHandle(M,k,ee)},ht.useInsertionEffect=function(M,k){return z.H.useInsertionEffect(M,k)},ht.useLayoutEffect=function(M,k){return z.H.useLayoutEffect(M,k)},ht.useMemo=function(M,k){return z.H.useMemo(M,k)},ht.useOptimistic=function(M,k){return z.H.useOptimistic(M,k)},ht.useReducer=function(M,k,ee){return z.H.useReducer(M,k,ee)},ht.useRef=function(M){return z.H.useRef(M)},ht.useState=function(M){return z.H.useState(M)},ht.useSyncExternalStore=function(M,k,ee){return z.H.useSyncExternalStore(M,k,ee)},ht.useTransition=function(){return z.H.useTransition()},ht.version="19.2.0",ht}var av;function ap(){return av||(av=1,bd.exports=US()),bd.exports}var q=ap(),Td={exports:{}},Go={},Ad={exports:{}},wd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var rv;function LS(){return rv||(rv=1,(function(s){function e(F,Q){var J=F.length;F.push(Q);e:for(;0<J;){var X=J-1>>>1,N=F[X];if(0<l(N,Q))F[X]=Q,F[J]=N,J=X;else break e}}function i(F){return F.length===0?null:F[0]}function a(F){if(F.length===0)return null;var Q=F[0],J=F.pop();if(J!==Q){F[0]=J;e:for(var X=0,N=F.length,M=N>>>1;X<M;){var k=2*(X+1)-1,ee=F[k],le=k+1,se=F[le];if(0>l(ee,J))le<N&&0>l(se,ee)?(F[X]=se,F[le]=J,X=le):(F[X]=ee,F[k]=J,X=k);else if(le<N&&0>l(se,J))F[X]=se,F[le]=J,X=le;else break e}}return Q}function l(F,Q){var J=F.sortIndex-Q.sortIndex;return J!==0?J:F.id-Q.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;s.unstable_now=function(){return c.now()}}else{var f=Date,d=f.now();s.unstable_now=function(){return f.now()-d}}var p=[],m=[],g=1,v=null,y=3,E=!1,b=!1,A=!1,x=!1,_=typeof setTimeout=="function"?setTimeout:null,O=typeof clearTimeout=="function"?clearTimeout:null,P=typeof setImmediate<"u"?setImmediate:null;function C(F){for(var Q=i(m);Q!==null;){if(Q.callback===null)a(m);else if(Q.startTime<=F)a(m),Q.sortIndex=Q.expirationTime,e(p,Q);else break;Q=i(m)}}function H(F){if(A=!1,C(F),!b)if(i(p)!==null)b=!0,W||(W=!0,re());else{var Q=i(m);Q!==null&&ue(H,Q.startTime-F)}}var W=!1,z=-1,K=5,U=-1;function L(){return x?!0:!(s.unstable_now()-U<K)}function Y(){if(x=!1,W){var F=s.unstable_now();U=F;var Q=!0;try{e:{b=!1,A&&(A=!1,O(z),z=-1),E=!0;var J=y;try{t:{for(C(F),v=i(p);v!==null&&!(v.expirationTime>F&&L());){var X=v.callback;if(typeof X=="function"){v.callback=null,y=v.priorityLevel;var N=X(v.expirationTime<=F);if(F=s.unstable_now(),typeof N=="function"){v.callback=N,C(F),Q=!0;break t}v===i(p)&&a(p),C(F)}else a(p);v=i(p)}if(v!==null)Q=!0;else{var M=i(m);M!==null&&ue(H,M.startTime-F),Q=!1}}break e}finally{v=null,y=J,E=!1}Q=void 0}}finally{Q?re():W=!1}}}var re;if(typeof P=="function")re=function(){P(Y)};else if(typeof MessageChannel<"u"){var ce=new MessageChannel,xe=ce.port2;ce.port1.onmessage=Y,re=function(){xe.postMessage(null)}}else re=function(){_(Y,0)};function ue(F,Q){z=_(function(){F(s.unstable_now())},Q)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(F){F.callback=null},s.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):K=0<F?Math.floor(1e3/F):5},s.unstable_getCurrentPriorityLevel=function(){return y},s.unstable_next=function(F){switch(y){case 1:case 2:case 3:var Q=3;break;default:Q=y}var J=y;y=Q;try{return F()}finally{y=J}},s.unstable_requestPaint=function(){x=!0},s.unstable_runWithPriority=function(F,Q){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var J=y;y=F;try{return Q()}finally{y=J}},s.unstable_scheduleCallback=function(F,Q,J){var X=s.unstable_now();switch(typeof J=="object"&&J!==null?(J=J.delay,J=typeof J=="number"&&0<J?X+J:X):J=X,F){case 1:var N=-1;break;case 2:N=250;break;case 5:N=1073741823;break;case 4:N=1e4;break;default:N=5e3}return N=J+N,F={id:g++,callback:Q,priorityLevel:F,startTime:J,expirationTime:N,sortIndex:-1},J>X?(F.sortIndex=J,e(m,F),i(p)===null&&F===i(m)&&(A?(O(z),z=-1):A=!0,ue(H,J-X))):(F.sortIndex=N,e(p,F),b||E||(b=!0,W||(W=!0,re()))),F},s.unstable_shouldYield=L,s.unstable_wrapCallback=function(F){var Q=y;return function(){var J=y;y=Q;try{return F.apply(this,arguments)}finally{y=J}}}})(wd)),wd}var sv;function OS(){return sv||(sv=1,Ad.exports=LS()),Ad.exports}var Rd={exports:{}},Un={};/**
 * @license React
...
`)+`
`+_);const P=O+x+f,C=O+_+d,H=a_(l,l.VERTEX_SHADER,P),W=a_(l,l.FRAGMENT_SHADER,C);l.attachShader(A,H),l.attachShader(A,W),i.index0AttributeName!==void 0?l.bindAttribLocation(A,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(A,0,"position"),l.linkProgram(A);function z(Y){if(s.debug.checkShaderErrors){const re=l.getProgramInfoLog(A)||"",ce=l.getShaderInfoLog(H)||"",xe=l.getShaderInfoLog(W)||"",ue=re.trim(),F=ce.trim(),Q=xe.trim();let J=!0,X=!0;if(l.getProgramParameter(A,l.LINK_STATUS)===!1)if(J=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,A,H,W);else{const N=s_(l,H,"vertex"),M=s_(l,W,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(A,l.VALIDATE_STATUS)+`
...
}`;function tR(s,e,i){let a=new _p;const l=new It,c=new It,f=new rn,d=new Ab({depthPacking:HE}),p=new wb,m={},g=i.maxTextureSize,v={[tr]:qn,[qn]:tr,[pa]:pa},y=new nr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new It},radius:{value:4}},vertexShader:$w,fragmentShader:eR}),E=y.clone();E.defines.HORIZONTAL_PASS=1;const b=new Ci;b.setAttribute("position",new Zn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const A=new oi(b,y),x=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=U_;let _=this.type;this.render=function(W,z,K){if(x.enabled===!1||x.autoUpdate===!1&&x.needsUpdate===!1||W.length===0)return;const U=s.getRenderTarget(),L=s.getActiveCubeFace(),Y=s.getActiveMipmapLevel(),re=s.state;re.setBlending($a),re.buffers.depth.getReversed()===!0?re.buffers.color.setClear(0,0,0,0):re.buffers.color.setClear(1,1,1,1),re.buffers.depth.setTest(!0),re.setScissorTest(!1);const ce=_!==ha&&this.type===ha,xe=_===ha&&this.type!==ha;for(let ue=0,F=W.length;ue<F;ue++){const Q=W[ue],J=Q.shadow;if(J===void 0){console.warn("THREE.WebGLShadowMap:",Q,"has no shadow.");continue}if(J.autoUpdate===!1&&J.needsUpdate===!1)continue;l.copy(J.mapSize);const X=J.getFrameExtents();if(l.multiply(X),c.copy(J.mapSize),(l.x>g||l.y>g)&&(l.x>g&&(c.x=Math.floor(g/X.x),l.x=c.x*X.x,J.mapSize.x=c.x),l.y>g&&(c.y=Math.floor(g/X.y),l.y=c.y*X.y,J.mapSize.y=c.y)),J.map===null||ce===!0||xe===!0){const M=this.type!==ha?{minFilter:Ri,magFilter:Ri}:{};J.map!==null&&J.map.dispose(),J.map=new Ir(l.x,l.y,M),J.map.texture.name=Q.name+".shadowMap",J.camera.updateProjectionMatrix()}s.setRenderTarget(J.map),s.clear();const N=J.getViewportCount();for(let M=0;M<N;M++){const k=J.getViewport(M);f.set(c.x*k.x,c.y*k.y,c.x*k.z,c.y*k.w),re.viewport(f),J.updateMatrices(Q,M),a=J.getFrustum(),C(z,K,J.camera,Q,this.type)}J.isPointLightShadow!==!0&&this.type===ha&&O(J,K),J.needsUpdate=!1}_=this.type,x.needsUpdate=!1,s.setRenderTarget(U,L,Y)};function O(W,z){const K=e.update(A);y.defines.VSM_SAMPLES!==W.blurSamples&&(y.defines.VSM_SAMPLES=W.blurSamples,E.defines.VSM_SAMPLES=W.blurSamples,y.needsUpdate=!0,E.needsUpdate=!0),W.mapPass===null&&(W.mapPass=new Ir(l.x,l.y)),y.uniforms.shadow_pass.value=W.map.texture,y.uniforms.resolution.value=W.mapSize,y.uniforms.radius.value=W.radius,s.setRenderTarget(W.mapPass),s.clear(),s.renderBufferDirect(z,null,K,y,A,null),E.uniforms.shadow_pass.value=W.mapPass.texture,E.uniforms.resolution.value=W.mapSize,E.uniforms.radius.value=W.radius,s.setRenderTarget(W.map),s.clear(),s.renderBufferDirect(z,null,K,E,A,null)}function P(W,z,K,U){let L=null;const Y=K.isPointLight===!0?W.customDistanceMaterial:W.customDepthMaterial;if(Y!==void 0)L=Y;else if(L=K.isPointLight===!0?p:d,s.localClippingEnabled&&z.clipShadows===!0&&Array.isArray(z.clippingPlanes)&&z.clippingPlanes.length!==0||z.displacementMap&&z.displacementScale!==0||z.alphaMap&&z.alphaTest>0||z.map&&z.alphaTest>0||z.alphaToCoverage===!0){const re=L.uuid,ce=z.uuid;let xe=m[re];xe===void 0&&(xe={},m[re]=xe);let ue=xe[ce];ue===void 0&&(ue=L.clone(),xe[ce]=ue,z.addEventListener("dispose",H)),L=ue}if(L.visible=z.visible,L.wireframe=z.wireframe,U===ha?L.side=z.shadowSide!==null?z.shadowSide:z.side:L.side=z.shadowSide!==null?z.shadowSide:v[z.side],L.alphaMap=z.alphaMap,L.alphaTest=z.alphaToCoverage===!0?.5:z.alphaTest,L.map=z.map,L.clipShadows=z.clipShadows,L.clippingPlanes=z.clippingPlanes,L.clipIntersection=z.clipIntersection,L.displacementMap=z.displacementMap,L.displacementScale=z.displacementScale,L.displacementBias=z.displacementBias,L.wireframeLinewidth=z.wireframeLinewidth,L.linewidth=z.linewidth,K.isPointLight===!0&&L.isMeshDistanceMaterial===!0){const re=s.properties.get(L);re.light=K}return L}function C(W,z,K,U,L){if(W.visible===!1)return;if(W.layers.test(z.layers)&&(W.isMesh||W.isLine||W.isPoints)&&(W.castShadow||W.receiveShadow&&L===ha)&&(!W.frustumCulled||a.intersectsObject(W))){W.modelViewMatrix.multiplyMatrices(K.matrixWorldInverse,W.matrixWorld);const ce=e.update(W),xe=W.material;if(Array.isArray(xe)){const ue=ce.groups;for(let F=0,Q=ue.length;F<Q;F++){const J=ue[F],X=xe[J.materialIndex];if(X&&X.visible){const N=P(W,X,U,L);W.onBeforeShadow(s,W,z,K,ce,N,J),s.renderBufferDirect(K,null,ce,N,W,J),W.onAfterShadow(s,W,z,K,ce,N,J)}}}else if(xe.visible){const ue=P(W,xe,U,L);W.onBeforeShadow(s,W,z,K,ce,ue,null),s.renderBufferDirect(K,null,ce,ue,W,null),W.onAfterShadow(s,W,z,K,ce,ue,null)}}const re=W.children;for(let ce=0,xe=re.length;ce<xe;ce++)C(re[ce],z,K,U,L)}function H(W){W.target.removeEventListener("dispose",H);for(const K in m){const U=m[K],L=W.target.uuid;L in U&&(U[L].dispose(),delete U[L])}}}const nR={[gh]:vh,[_h]:Sh,[xh]:Mh,[Fs]:yh,[vh]:gh,[Sh]:_h,[Mh]:xh,[yh]:Fs};function iR(s,e){function i(){let $=!1;const Ue=new rn;let Pe=null;const Ye=new rn(0,0,0,0);return{setMask:function(Ce){Pe!==Ce&&!$&&(s.colorMask(Ce,Ce,Ce,Ce),Pe=Ce)},setLocked:function(Ce){$=Ce},setClear:function(Ce,Ae,Ze,dt,Ht){Ht===!0&&(Ce*=dt,Ae*=dt,Ze*=dt),Ue.set(Ce,Ae,Ze,dt),Ye.equals(Ue)===!1&&(s.clearColor(Ce,Ae,Ze,dt),Ye.copy(Ue))},reset:function(){$=!1,Pe=null,Ye.set(-1,0,0,0)}}}function a(){let $=!1,Ue=!1,Pe=null,Ye=null,Ce=null;return{setReversed:function(Ae){if(Ue!==Ae){const Ze=e.get("EXT_clip_control");Ae?Ze.clipControlEXT(Ze.LOWER_LEFT_EXT,Ze.ZERO_TO_ONE_EXT):Ze.clipControlEXT(Ze.LOWER_LEFT_EXT,Ze.NEGATIVE_ONE_TO_ONE_EXT),Ue=Ae;const dt=Ce;Ce=null,this.setClear(dt)}},getReversed:function(){return Ue},setTest:function(Ae){Ae?I(s.DEPTH_TEST):te(s.DEPTH_TEST)},setMask:function(Ae){Pe!==Ae&&!$&&(s.depthMask(Ae),Pe=Ae)},setFunc:function(Ae){if(Ue&&(Ae=nR[Ae]),Ye!==Ae){switch(Ae){case gh:s.depthFunc(s.NEVER);break;case vh:s.depthFunc(s.ALWAYS);break;case _h:s.depthFunc(s.LESS);break;case Fs:s.depthFunc(s.LEQUAL);break;case xh:s.depthFunc(s.EQUAL);break;case yh:s.depthFunc(s.GEQUAL);break;case Sh:s.depthFunc(s.GREATER);break;case Mh:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}Ye=Ae}},setLocked:function(Ae){$=Ae},setClear:function(Ae){Ce!==Ae&&(Ue&&(Ae=1-Ae),s.clearDepth(Ae),Ce=Ae)},reset:function(){$=!1,Pe=null,Ye=null,Ce=null,Ue=!1}}}function l(){let $=!1,Ue=null,Pe=null,Ye=null,Ce=null,Ae=null,Ze=null,dt=null,Ht=null;return{setTest:function(Nt){$||(Nt?I(s.STENCIL_TEST):te(s.STENCIL_TEST))},setMask:function(Nt){Ue!==Nt&&!$&&(s.stencilMask(Nt),Ue=Nt)},setFunc:function(Nt,Pn,li){(Pe!==Nt||Ye!==Pn||Ce!==li)&&(s.stencilFunc(Nt,Pn,li),Pe=Nt,Ye=Pn,Ce=li)},setOp:function(Nt,Pn,li){(Ae!==Nt||Ze!==Pn||dt!==li)&&(s.stencilOp(Nt,Pn,li),Ae=Nt,Ze=Pn,dt=li)},setLocked:function(Nt){$=Nt},setClear:function(Nt){Ht!==Nt&&(s.clearStencil(Nt),Ht=Nt)},reset:function(){$=!1,Ue=null,Pe=null,Ye=null,Ce=null,Ae=null,Ze=null,dt=null,Ht=null}}}const c=new i,f=new a,d=new l,p=new WeakMap,m=new WeakMap;let g={},v={},y=new WeakMap,E=[],b=null,A=!1,x=null,_=null,O=null,P=null,C=null,H=null,W=null,z=new Dt(0,0,0),K=0,U=!1,L=null,Y=null,re=null,ce=null,xe=null;const ue=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let F=!1,Q=0;const J=s.getParameter(s.VERSION);J.indexOf("WebGL")!==-1?(Q=parseFloat(/^WebGL (\d)/.exec(J)[1]),F=Q>=1):J.indexOf("OpenGL ES")!==-1&&(Q=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),F=Q>=2);let X=null,N={};const M=s.getParameter(s.SCISSOR_BOX),k=s.getParameter(s.VIEWPORT),ee=new rn().fromArray(M),le=new rn().fromArray(k);function se($,Ue,Pe,Ye){const Ce=new Uint8Array(4),Ae=s.createTexture();s.bindTexture($,Ae),s.texParameteri($,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri($,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let Ze=0;Ze<Pe;Ze++)$===s.TEXTURE_3D||$===s.TEXTURE_2D_ARRAY?s.texImage3D(Ue,0,s.RGBA,1,1,Ye,0,s.RGBA,s.UNSIGNED_BYTE,Ce):s.texImage2D(Ue+Ze,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,Ce);return Ae}const T={};T[s.TEXTURE_2D]=se(s.TEXTURE_2D,s.TEXTURE_2D,1),T[s.TEXTURE_CUBE_MAP]=se(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),T[s.TEXTURE_2D_ARRAY]=se(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),T[s.TEXTURE_3D]=se(s.TEXTURE_3D,s.TEXTURE_3D,1,1),c.setClear(0,0,0,1),f.setClear(1),d.setClear(0),I(s.DEPTH_TEST),f.setFunc(Fs),Xe(!1),ze(gv),I(s.CULL_FACE),Ie($a);function I($){g[$]!==!0&&(s.enable($),g[$]=!0)}function te($){g[$]!==!1&&(s.disable($),g[$]=!1)}function oe($,Ue){return v[$]!==Ue?(s.bindFramebuffer($,Ue),v[$]=Ue,$===s.DRAW_FRAMEBUFFER&&(v[s.FRAMEBUFFER]=Ue),$===s.FRAMEBUFFER&&(v[s.DRAW_FRAMEBUFFER]=Ue),!0):!1}function Ee($,Ue){let Pe=E,Ye=!1;if($){Pe=y.get(Ue),Pe===void 0&&(Pe=[],y.set(Ue,Pe));const Ce=$.textures;if(Pe.length!==Ce.length||Pe[0]!==s.COLOR_ATTACHMENT0){for(let Ae=0,Ze=Ce.length;Ae<Ze;Ae++)Pe[Ae]=s.COLOR_ATTACHMENT0+Ae;Pe.length=Ce.length,Ye=!0}}else Pe[0]!==s.BACK&&(Pe[0]=s.BACK,Ye=!0);Ye&&s.drawBuffers(Pe)}function Ne($){return b!==$?(s.useProgram($),b=$,!0):!1}const ke={[Dr]:s.FUNC_ADD,[dE]:s.FUNC_SUBTRACT,[hE]:s.FUNC_REVERSE_SUBTRACT};ke[pE]=s.MIN,ke[mE]=s.MAX;const V={[gE]:s.ZERO,[vE]:s.ONE,[_E]:s.SRC_COLOR,[ph]:s.SRC_ALPHA,[bE]:s.SRC_ALPHA_SATURATE,[ME]:s.DST_COLOR,[yE]:s.DST_ALPHA,[xE]:s.ONE_MINUS_SRC_COLOR,[mh]:s.ONE_MINUS_SRC_ALPHA,[EE]:s.ONE_MINUS_DST_COLOR,[SE]:s.ONE_MINUS_DST_ALPHA,[TE]:s.CONSTANT_COLOR,[AE]:s.ONE_MINUS_CONSTANT_COLOR,[wE]:s.CONSTANT_ALPHA,[RE]:s.ONE_MINUS_CONSTANT_ALPHA};function Ie($,Ue,Pe,Ye,Ce,Ae,Ze,dt,Ht,Nt){if($===$a){A===!0&&(te(s.BLEND),A=!1);return}if(A===!1&&(I(s.BLEND),A=!0),$!==fE){if($!==x||Nt!==U){if((_!==Dr||C!==Dr)&&(s.blendEquation(s.FUNC_ADD),_=Dr,C=Dr),Nt)switch($){case Ps:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case hh:s.blendFunc(s.ONE,s.ONE);break;case vv:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case _v:s.blendFuncSeparate(s.DST_COLOR,s.ONE_MINUS_SRC_ALPHA,s.ZERO,s.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",$);break}else switch($){case Ps:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case hh:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE,s.ONE,s.ONE);break;case vv:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case _v:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",$);break}O=null,P=null,H=null,W=null,z.set(0,0,0),K=0,x=$,U=Nt}return}Ce=Ce||Ue,Ae=Ae||Pe,Ze=Ze||Ye,(Ue!==_||Ce!==C)&&(s.blendEquationSeparate(ke[Ue],ke[Ce]),_=Ue,C=Ce),(Pe!==O||Ye!==P||Ae!==H||Ze!==W)&&(s.blendFuncSeparate(V[Pe],V[Ye],V[Ae],V[Ze]),O=Pe,P=Ye,H=Ae,W=Ze),(dt.equals(z)===!1||Ht!==K)&&(s.blendColor(dt.r,dt.g,dt.b,Ht),z.copy(dt),K=Ht),x=$,U=!1}function Be($,Ue){$.side===pa?te(s.CULL_FACE):I(s.CULL_FACE);let Pe=$.side===qn;Ue&&(Pe=!Pe),Xe(Pe),$.blending===Ps&&$.transparent===!1?Ie($a):Ie($.blending,$.blendEquation,$.blendSrc,$.blendDst,$.blendEquationAlpha,$.blendSrcAlpha,$.blendDstAlpha,$.blendColor,$.blendAlpha,$.premultipliedAlpha),f.setFunc($.depthFunc),f.setTest($.depthTest),f.setMask($.depthWrite),c.setMask($.colorWrite);const Ye=$.stencilWrite;d.setTest(Ye),Ye&&(d.setMask($.stencilWriteMask),d.setFunc($.stencilFunc,$.stencilRef,$.stencilFuncMask),d.setOp($.stencilFail,$.stencilZFail,$.stencilZPass)),Fe($.polygonOffset,$.polygonOffsetFactor,$.polygonOffsetUnits),$.alphaToCoverage===!0?I(s.SAMPLE_ALPHA_TO_COVERAGE):te(s.SAMPLE_ALPHA_TO_COVERAGE)}function Xe($){L!==$&&($?s.frontFace(s.CW):s.frontFace(s.CCW),L=$)}function ze($){$!==lE?(I(s.CULL_FACE),$!==Y&&($===gv?s.cullFace(s.BACK):$===cE?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):te(s.CULL_FACE),Y=$}function _t($){$!==re&&(F&&s.lineWidth($),re=$)}function Fe($,Ue,Pe){$?(I(s.POLYGON_OFFSET_FILL),(ce!==Ue||xe!==Pe)&&(s.polygonOffset(Ue,Pe),ce=Ue,xe=Pe)):te(s.POLYGON_OFFSET_FILL)}function at($){$?I(s.SCISSOR_TEST):te(s.SCISSOR_TEST)}function Yt($){$===void 0&&($=s.TEXTURE0+ue-1),X!==$&&(s.activeTexture($),X=$)}function kt($,Ue,Pe){Pe===void 0&&(X===null?Pe=s.TEXTURE0+ue-1:Pe=X);let Ye=N[Pe];Ye===void 0&&(Ye={type:void 0,texture:void 0},N[Pe]=Ye),(Ye.type!==$||Ye.texture!==Ue)&&(X!==Pe&&(s.activeTexture(Pe),X=Pe),s.bindTexture($,Ue||T[$]),Ye.type=$,Ye.texture=Ue)}function G(){const $=N[X];$!==void 0&&$.type!==void 0&&(s.bindTexture($.type,null),$.type=void 0,$.texture=void 0)}function w(){try{s.compressedTexImage2D(...arguments)}catch($){console.error("THREE.WebGLState:",$)}}function fe(){try{s.compressedTexImage3D(...arguments)}catch($){console.error("THREE.WebGLState:",$)}}function Me(){try{s.texSubImage2D(...arguments)}catch($){console.error("THREE.WebGLState:",$)}}function Re(){try{s.texSubImage3D(...arguments)}catch($){console.error("THREE.WebGLState:",$)}}function ye(){try{s.compressedTexSubImage2D(...arguments)}catch($){console.error("THREE.WebGLState:",$)}}function tt(){try{s.compressedTexSubImage3D(...arguments)}catch($){console.error("THREE.WebGLState:",$)}}function Le(){try{s.texStorage2D(...arguments)}catch($){console.error("THREE.WebGLState:",$)}}function Qe(){try{s.texStorage3D(...arguments)}catch($){console.error("THREE.WebGLState:",$)}}function nt(){try{s.texImage2D(...arguments)}catch($){console.error("THREE.WebGLState:",$)}}function De(){try{s.texImage3D(...arguments)}catch($){console.error("THREE.WebGLState:",$)}}function Oe($){ee.equals($)===!1&&(s.scissor($.x,$.y,$.z,$.w),ee.copy($))}function rt($){le.equals($)===!1&&(s.viewport($.x,$.y,$.z,$.w),le.copy($))}function je($,Ue){let Pe=m.get(Ue);Pe===void 0&&(Pe=new WeakMap,m.set(Ue,Pe));let Ye=Pe.get($);Ye===void 0&&(Ye=s.getUniformBlockIndex(Ue,$.name),Pe.set($,Ye))}function He($,Ue){const Ye=m.get(Ue).get($);p.get(Ue)!==Ye&&(s.uniformBlockBinding(Ue,Ye,$.__bindingPointIndex),p.set(Ue,Ye))}function pt(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),f.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),g={},X=null,N={},v={},y=new WeakMap,E=[],b=null,A=!1,x=null,_=null,O=null,P=null,C=null,H=null,W=null,z=new Dt(0,0,0),K=0,U=!1,L=null,Y=null,re=null,ce=null,xe=null,ee.set(0,0,s.canvas.width,s.canvas.height),le.set(0,0,s.canvas.width,s.canvas.height),c.reset(),f.reset(),d.reset()}return{buffers:{color:c,depth:f,stencil:d},enable:I,disable:te,bindFramebuffer:oe,drawBuffers:Ee,useProgram:Ne,setBlending:Ie,setMaterial:Be,setFlipSided:Xe,setCullFace:ze,setLineWidth:_t,setPolygonOffset:Fe,setScissorTest:at,activeTexture:Yt,bindTexture:kt,unbindTexture:G,compressedTexImage2D:w,compressedTexImage3D:fe,texImage2D:nt,texImage3D:De,updateUBOMapping:je,uniformBlockBinding:He,texStorage2D:Le,texStorage3D:Qe,texSubImage2D:Me,texSubImage3D:Re,compressedTexSubImage2D:ye,compressedTexSubImage3D:tt,scissor:Oe,viewport:rt,reset:pt}}function aR(s,e,i,a,l,c,f){const d=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),m=new It,g=new WeakMap;let v;const y=new WeakMap;let E=!1;try{E=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(G,w){return E?new OffscreenCanvas(G,w):su("canvas")}function A(G,w,fe){let Me=1;const Re=kt(G);if((Re.width>fe||Re.height>fe)&&(Me=fe/Math.max(Re.width,Re.height)),Me<1)if(typeof HTMLImageElement<"u"&&G instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&G instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&G instanceof ImageBitmap||typeof VideoFrame<"u"&&G instanceof VideoFrame){const ye=Math.floor(Me*Re.width),tt=Math.floor(Me*Re.height);v===void 0&&(v=b(ye,tt));const Le=w?b(ye,tt):v;return Le.width=ye,Le.height=tt,Le.getContext("2d").drawImage(G,0,0,ye,tt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Re.width+"x"+Re.height+") to ("+ye+"x"+tt+")."),Le}else return"data"in G&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Re.width+"x"+Re.height+")."),G;return G}function x(G){return G.generateMipmaps}function _(G){s.generateMipmap(G)}function O(G){return G.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:G.isWebGL3DRenderTarget?s.TEXTURE_3D:G.isWebGLArrayRenderTarget||G.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function P(G,w,fe,Me,Re=!1){if(G!==null){if(s[G]!==void 0)return s[G];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+G+"'")}let ye=w;if(w===s.RED&&(fe===s.FLOAT&&(ye=s.R32F),fe===s.HALF_FLOAT&&(ye=s.R16F),fe===s.UNSIGNED_BYTE&&(ye=s.R8)),w===s.RED_INTEGER&&(fe===s.UNSIGNED_BYTE&&(ye=s.R8UI),fe===s.UNSIGNED_SHORT&&(ye=s.R16UI),fe===s.UNSIGNED_INT&&(ye=s.R32UI),fe===s.BYTE&&(ye=s.R8I),fe===s.SHORT&&(ye=s.R16I),fe===s.INT&&(ye=s.R32I)),w===s.RG&&(fe===s.FLOAT&&(ye=s.RG32F),fe===s.HALF_FLOAT&&(ye=s.RG16F),fe===s.UNSIGNED_BYTE&&(ye=s.RG8)),w===s.RG_INTEGER&&(fe===s.UNSIGNED_BYTE&&(ye=s.RG8UI),fe===s.UNSIGNED_SHORT&&(ye=s.RG16UI),fe===s.UNSIGNED_INT&&(ye=s.RG32UI),fe===s.BYTE&&(ye=s.RG8I),fe===s.SHORT&&(ye=s.RG16I),fe===s.INT&&(ye=s.RG32I)),w===s.RGB_INTEGER&&(fe===s.UNSIGNED_BYTE&&(ye=s.RGB8UI),fe===s.UNSIGNED_SHORT&&(ye=s.RGB16UI),fe===s.UNSIGNED_INT&&(ye=s.RGB32UI),fe===s.BYTE&&(ye=s.RGB8I),fe===s.SHORT&&(ye=s.RGB16I),fe===s.INT&&(ye=s.RGB32I)),w===s.RGBA_INTEGER&&(fe===s.UNSIGNED_BYTE&&(ye=s.RGBA8UI),fe===s.UNSIGNED_SHORT&&(ye=s.RGBA16UI),fe===s.UNSIGNED_INT&&(ye=s.RGBA32UI),fe===s.BYTE&&(ye=s.RGBA8I),fe===s.SHORT&&(ye=s.RGBA16I),fe===s.INT&&(ye=s.RGBA32I)),w===s.RGB&&(fe===s.UNSIGNED_INT_5_9_9_9_REV&&(ye=s.RGB9_E5),fe===s.UNSIGNED_INT_10F_11F_11F_REV&&(ye=s.R11F_G11F_B10F)),w===s.RGBA){const tt=Re?au:Pt.getTransfer(Me);fe===s.FLOAT&&(ye=s.RGBA32F),fe===s.HALF_FLOAT&&(ye=s.RGBA16F),fe===s.UNSIGNED_BYTE&&(ye=tt===qt?s.SRGB8_ALPHA8:s.RGBA8),fe===s.UNSIGNED_SHORT_4_4_4_4&&(ye=s.RGBA4),fe===s.UNSIGNED_SHORT_5_5_5_1&&(ye=s.RGB5_A1)}return(ye===s.R16F||ye===s.R32F||ye===s.RG16F||ye===s.RG32F||ye===s.RGBA16F||ye===s.RGBA32F)&&e.get("EXT_color_buffer_float"),ye}function C(G,w){let fe;return G?w===null||w===Pr||w===el?fe=s.DEPTH24_STENCIL8:w===ma?fe=s.DEPTH32F_STENCIL8:w===$o&&(fe=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):w===null||w===Pr||w===el?fe=s.DEPTH_COMPONENT24:w===ma?fe=s.DEPTH_COMPONENT32F:w===$o&&(fe=s.DEPTH_COMPONENT16),fe}function H(G,w){return x(G)===!0||G.isFramebufferTexture&&G.minFilter!==Ri&&G.minFilter!==Bi?Math.log2(Math.max(w.width,w.height))+1:G.mipmaps!==void 0&&G.mipmaps.length>0?G.mipmaps.length:G.isCompressedTexture&&Array.isArray(G.image)?w.mipmaps.length:1}function W(G){const w=G.target;w.removeEventListener("dispose",W),K(w),w.isVideoTexture&&g.delete(w)}function z(G){const w=G.target;w.removeEventListener("dispose",z),L(w)}function K(G){const w=a.get(G);if(w.__webglInit===void 0)return;const fe=G.source,Me=y.get(fe);if(Me){const Re=Me[w.__cacheKey];Re.usedTimes--,Re.usedTimes===0&&U(G),Object.keys(Me).length===0&&y.delete(fe)}a.remove(G)}function U(G){const w=a.get(G);s.deleteTexture(w.__webglTexture);const fe=G.source,Me=y.get(fe);delete Me[w.__cacheKey],f.memory.textures--}function L(G){const w=a.get(G);if(G.depthTexture&&(G.depthTexture.dispose(),a.remove(G.depthTexture)),G.isWebGLCubeRenderTarget)for(let Me=0;Me<6;Me++){if(Array.isArray(w.__webglFramebuffer[Me]))for(let Re=0;Re<w.__webglFramebuffer[Me].length;Re++)s.deleteFramebuffer(w.__webglFramebuffer[Me][Re]);else s.deleteFramebuffer(w.__webglFramebuffer[Me]);w.__webglDepthbuffer&&s.deleteRenderbuffer(w.__webglDepthbuffer[Me])}else{if(Array.isArray(w.__webglFramebuffer))for(let Me=0;Me<w.__webglFramebuffer.length;Me++)s.deleteFramebuffer(w.__webglFramebuffer[Me]);else s.deleteFramebuffer(w.__webglFramebuffer);if(w.__webglDepthbuffer&&s.deleteRenderbuffer(w.__webglDepthbuffer),w.__webglMultisampledFramebuffer&&s.deleteFramebuffer(w.__webglMultisampledFramebuffer),w.__webglColorRenderbuffer)for(let Me=0;Me<w.__webglColorRenderbuffer.length;Me++)w.__webglColorRenderbuffer[Me]&&s.deleteRenderbuffer(w.__webglColorRenderbuffer[Me]);w.__webglDepthRenderbuffer&&s.deleteRenderbuffer(w.__webglDepthRenderbuffer)}const fe=G.textures;for(let Me=0,Re=fe.length;Me<Re;Me++){const ye=a.get(fe[Me]);ye.__webglTexture&&(s.deleteTexture(ye.__webglTexture),f.memory.textures--),a.remove(fe[Me])}a.remove(G)}let Y=0;function re(){Y=0}function ce(){const G=Y;return G>=l.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+G+" texture units while this GPU supports only "+l.maxTextures),Y+=1,G}function xe(G){const w=[];return w.push(G.wrapS),w.push(G.wrapT),w.push(G.wrapR||0),w.push(G.magFilter),w.push(G.minFilter),w.push(G.anisotropy),w.push(G.internalFormat),w.push(G.format),w.push(G.type),w.push(G.generateMipmaps),w.push(G.premultiplyAlpha),w.push(G.flipY),w.push(G.unpackAlignment),w.push(G.colorSpace),w.join()}function ue(G,w){const fe=a.get(G);if(G.isVideoTexture&&at(G),G.isRenderTargetTexture===!1&&G.isExternalTexture!==!0&&G.version>0&&fe.__version!==G.version){const Me=G.image;if(Me===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Me.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{T(fe,G,w);return}}else G.isExternalTexture&&(fe.__webglTexture=G.sourceTexture?G.sourceTexture:null);i.bindTexture(s.TEXTURE_2D,fe.__webglTexture,s.TEXTURE0+w)}function F(G,w){const fe=a.get(G);if(G.isRenderTargetTexture===!1&&G.version>0&&fe.__version!==G.version){T(fe,G,w);return}i.bindTexture(s.TEXTURE_2D_ARRAY,fe.__webglTexture,s.TEXTURE0+w)}function Q(G,w){const fe=a.get(G);if(G.isRenderTargetTexture===!1&&G.version>0&&fe.__version!==G.version){T(fe,G,w);return}i.bindTexture(s.TEXTURE_3D,fe.__webglTexture,s.TEXTURE0+w)}function J(G,w){const fe=a.get(G);if(G.version>0&&fe.__version!==G.version){I(fe,G,w);return}i.bindTexture(s.TEXTURE_CUBE_MAP,fe.__webglTexture,s.TEXTURE0+w)}const X={[Th]:s.REPEAT,[Ur]:s.CLAMP_TO_EDGE,[Ah]:s.MIRRORED_REPEAT},N={[Ri]:s.NEAREST,[zE]:s.NEAREST_MIPMAP_NEAREST,[Tc]:s.NEAREST_MIPMAP_LINEAR,[Bi]:s.LINEAR,[Nd]:s.LINEAR_MIPMAP_NEAREST,[Lr]:s.LINEAR_MIPMAP_LINEAR},M={[VE]:s.NEVER,[YE]:s.ALWAYS,[kE]:s.LESS,[W_]:s.LEQUAL,[WE]:s.EQUAL,[qE]:s.GEQUAL,[XE]:s.GREATER,[jE]:s.NOTEQUAL};function k(G,w){if(w.type===ma&&e.has("OES_texture_float_linear")===!1&&(w.magFilter===Bi||w.magFilter===Nd||w.magFilter===Tc||w.magFilter===Lr||w.minFilter===Bi||w.minFilter===Nd||w.minFilter===Tc||w.minFilter===Lr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(G,s.TEXTURE_WRAP_S,X[w.wrapS]),s.texParameteri(G,s.TEXTURE_WRAP_T,X[w.wrapT]),(G===s.TEXTURE_3D||G===s.TEXTURE_2D_ARRAY)&&s.texParameteri(G,s.TEXTURE_WRAP_R,X[w.wrapR]),s.texParameteri(G,s.TEXTURE_MAG_FILTER,N[w.magFilter]),s.texParameteri(G,s.TEXTURE_MIN_FILTER,N[w.minFilter]),w.compareFunction&&(s.texParameteri(G,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(G,s.TEXTURE_COMPARE_FUNC,M[w.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(w.magFilter===Ri||w.minFilter!==Tc&&w.minFilter!==Lr||w.type===ma&&e.has("OES_texture_float_linear")===!1)return;if(w.anisotropy>1||a.get(w).__currentAnisotropy){const fe=e.get("EXT_texture_filter_anisotropic");s.texParameterf(G,fe.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(w.anisotropy,l.getMaxAnisotropy())),a.get(w).__currentAnisotropy=w.anisotropy}}}function ee(G,w){let fe=!1;G.__webglInit===void 0&&(G.__webglInit=!0,w.addEventListener("dispose",W));const Me=w.source;let Re=y.get(Me);Re===void 0&&(Re={},y.set(Me,Re));const ye=xe(w);if(ye!==G.__cacheKey){Re[ye]===void 0&&(Re[ye]={texture:s.createTexture(),usedTimes:0},f.memory.textures++,fe=!0),Re[ye].usedTimes++;const tt=Re[G.__cacheKey];tt!==void 0&&(Re[G.__cacheKey].usedTimes--,tt.usedTimes===0&&U(w)),G.__cacheKey=ye,G.__webglTexture=Re[ye].texture}return fe}function le(G,w,fe){return Math.floor(Math.floor(G/fe)/w)}function se(G,w,fe,Me){const ye=G.updateRanges;if(ye.length===0)i.texSubImage2D(s.TEXTURE_2D,0,0,0,w.width,w.height,fe,Me,w.data);else{ye.sort((De,Oe)=>De.start-Oe.start);let tt=0;for(let De=1;De<ye.length;De++){const Oe=ye[tt],rt=ye[De],je=Oe.start+Oe.count,He=le(rt.start,w.width,4),pt=le(Oe.start,w.width,4);rt.start<=je+1&&He===pt&&le(rt.start+rt.count-1,w.width,4)===He?Oe.count=Math.max(Oe.count,rt.start+rt.count-Oe.start):(++tt,ye[tt]=rt)}ye.length=tt+1;const Le=s.getParameter(s.UNPACK_ROW_LENGTH),Qe=s.getParameter(s.UNPACK_SKIP_PIXELS),nt=s.getParameter(s.UNPACK_SKIP_ROWS);s.pixelStorei(s.UNPACK_ROW_LENGTH,w.width);for(let De=0,Oe=ye.length;De<Oe;De++){const rt=ye[De],je=Math.floor(rt.start/4),He=Math.ceil(rt.count/4),pt=je%w.width,$=Math.floor(je/w.width),Ue=He,Pe=1;s.pixelStorei(s.UNPACK_SKIP_PIXELS,pt),s.pixelStorei(s.UNPACK_SKIP_ROWS,$),i.texSubImage2D(s.TEXTURE_2D,0,pt,$,Ue,Pe,fe,Me,w.data)}G.clearUpdateRanges(),s.pixelStorei(s.UNPACK_ROW_LENGTH,Le),s.pixelStorei(s.UNPACK_SKIP_PIXELS,Qe),s.pixelStorei(s.UNPACK_SKIP_ROWS,nt)}}function T(G,w,fe){let Me=s.TEXTURE_2D;(w.isDataArrayTexture||w.isCompressedArrayTexture)&&(Me=s.TEXTURE_2D_ARRAY),w.isData3DTexture&&(Me=s.TEXTURE_3D);const Re=ee(G,w),ye=w.source;i.bindTexture(Me,G.__webglTexture,s.TEXTURE0+fe);const tt=a.get(ye);if(ye.version!==tt.__version||Re===!0){i.activeTexture(s.TEXTURE0+fe);const Le=Pt.getPrimaries(Pt.workingColorSpace),Qe=w.colorSpace===Ja?null:Pt.getPrimaries(w.colorSpace),nt=w.colorSpace===Ja||Le===Qe?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,w.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,w.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,w.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,nt);let De=A(w.image,!1,l.maxTextureSize);De=Yt(w,De);const Oe=c.convert(w.format,w.colorSpace),rt=c.convert(w.type);let je=P(w.internalFormat,Oe,rt,w.colorSpace,w.isVideoTexture);k(Me,w);let He;const pt=w.mipmaps,$=w.isVideoTexture!==!0,Ue=tt.__version===void 0||Re===!0,Pe=ye.dataReady,Ye=H(w,De);if(w.isDepthTexture)je=C(w.format===nl,w.type),Ue&&($?i.texStorage2D(s.TEXTURE_2D,1,je,De.width,De.height):i.texImage2D(s.TEXTURE_2D,0,je,De.width,De.height,0,Oe,rt,null));else if(w.isDataTexture)if(pt.length>0){$&&Ue&&i.texStorage2D(s.TEXTURE_2D,Ye,je,pt[0].width,pt[0].height);for(let Ce=0,Ae=pt.length;Ce<Ae;Ce++)He=pt[Ce],$?Pe&&i.texSubImage2D(s.TEXTURE_2D,Ce,0,0,He.width,He.height,Oe,rt,He.data):i.texImage2D(s.TEXTURE_2D,Ce,je,He.width,He.height,0,Oe,rt,He.data);w.generateMipmaps=!1}else $?(Ue&&i.texStorage2D(s.TEXTURE_2D,Ye,je,De.width,De.height),Pe&&se(w,De,Oe,rt)):i.texImage2D(s.TEXTURE_2D,0,je,De.width,De.height,0,Oe,rt,De.data);else if(w.isCompressedTexture)if(w.isCompressedArrayTexture){$&&Ue&&i.texStorage3D(s.TEXTURE_2D_ARRAY,Ye,je,pt[0].width,pt[0].height,De.depth);for(let Ce=0,Ae=pt.length;Ce<Ae;Ce++)if(He=pt[Ce],w.format!==wi)if(Oe!==null)if($){if(Pe)if(w.layerUpdates.size>0){const Ze=kv(He.width,He.height,w.format,w.type);for(const dt of w.layerUpdates){const Ht=He.data.subarray(dt*Ze/He.data.BYTES_PER_ELEMENT,(dt+1)*Ze/He.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Ce,0,0,dt,He.width,He.height,1,Oe,Ht)}w.clearLayerUpdates()}else i.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,Ce,0,0,0,He.width,He.height,De.depth,Oe,He.data)}else i.compressedTexImage3D(s.TEXTURE_2D_ARRAY,Ce,je,He.width,He.height,De.depth,0,He.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else $?Pe&&i.texSubImage3D(s.TEXTURE_2D_ARRAY,Ce,0,0,0,He.width,He.height,De.depth,Oe,rt,He.data):i.texImage3D(s.TEXTURE_2D_ARRAY,Ce,je,He.width,He.height,De.depth,0,Oe,rt,He.data)}else{$&&Ue&&i.texStorage2D(s.TEXTURE_2D,Ye,je,pt[0].width,pt[0].height);for(let Ce=0,Ae=pt.length;Ce<Ae;Ce++)He=pt[Ce],w.format!==wi?Oe!==null?$?Pe&&i.compressedTexSubImage2D(s.TEXTURE_2D,Ce,0,0,He.width,He.height,Oe,He.data):i.compressedTexImage2D(s.TEXTURE_2D,Ce,je,He.width,He.height,0,He.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):$?Pe&&i.texSubImage2D(s.TEXTURE_2D,Ce,0,0,He.width,He.height,Oe,rt,He.data):i.texImage2D(s.TEXTURE_2D,Ce,je,He.width,He.height,0,Oe,rt,He.data)}else if(w.isDataArrayTexture)if($){if(Ue&&i.texStorage3D(s.TEXTURE_2D_ARRAY,Ye,je,De.width,De.height,De.depth),Pe)if(w.layerUpdates.size>0){const Ce=kv(De.width,De.height,w.format,w.type);for(const Ae of w.layerUpdates){const Ze=De.data.subarray(Ae*Ce/De.data.BYTES_PER_ELEMENT,(Ae+1)*Ce/De.data.BYTES_PER_ELEMENT);i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,Ae,De.width,De.height,1,Oe,rt,Ze)}w.clearLayerUpdates()}else i.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,De.width,De.height,De.depth,Oe,rt,De.data)}else i.texImage3D(s.TEXTURE_2D_ARRAY,0,je,De.width,De.height,De.depth,0,Oe,rt,De.data);else if(w.isData3DTexture)$?(Ue&&i.texStorage3D(s.TEXTURE_3D,Ye,je,De.width,De.height,De.depth),Pe&&i.texSubImage3D(s.TEXTURE_3D,0,0,0,0,De.width,De.height,De.depth,Oe,rt,De.data)):i.texImage3D(s.TEXTURE_3D,0,je,De.width,De.height,De.depth,0,Oe,rt,De.data);else if(w.isFramebufferTexture){if(Ue)if($)i.texStorage2D(s.TEXTURE_2D,Ye,je,De.width,De.height);else{let Ce=De.width,Ae=De.height;for(let Ze=0;Ze<Ye;Ze++)i.texImage2D(s.TEXTURE_2D,Ze,je,Ce,Ae,0,Oe,rt,null),Ce>>=1,Ae>>=1}}else if(pt.length>0){if($&&Ue){const Ce=kt(pt[0]);i.texStorage2D(s.TEXTURE_2D,Ye,je,Ce.width,Ce.height)}for(let Ce=0,Ae=pt.length;Ce<Ae;Ce++)He=pt[Ce],$?Pe&&i.texSubImage2D(s.TEXTURE_2D,Ce,0,0,Oe,rt,He):i.texImage2D(s.TEXTURE_2D,Ce,je,Oe,rt,He);w.generateMipmaps=!1}else if($){if(Ue){const Ce=kt(De);i.texStorage2D(s.TEXTURE_2D,Ye,je,Ce.width,Ce.height)}Pe&&i.texSubImage2D(s.TEXTURE_2D,0,0,0,Oe,rt,De)}else i.texImage2D(s.TEXTURE_2D,0,je,Oe,rt,De);x(w)&&_(Me),tt.__version=ye.version,w.onUpdate&&w.onUpdate(w)}G.__version=w.version}function I(G,w,fe){if(w.image.length!==6)return;const Me=ee(G,w),Re=w.source;i.bindTexture(s.TEXTURE_CUBE_MAP,G.__webglTexture,s.TEXTURE0+fe);const ye=a.get(Re);if(Re.version!==ye.__version||Me===!0){i.activeTexture(s.TEXTURE0+fe);const tt=Pt.getPrimaries(Pt.workingColorSpace),Le=w.colorSpace===Ja?null:Pt.getPrimaries(w.colorSpace),Qe=w.colorSpace===Ja||tt===Le?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,w.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,w.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,w.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Qe);const nt=w.isCompressedTexture||w.image[0].isCompressedTexture,De=w.image[0]&&w.image[0].isDataTexture,Oe=[];for(let Ae=0;Ae<6;Ae++)!nt&&!De?Oe[Ae]=A(w.image[Ae],!0,l.maxCubemapSize):Oe[Ae]=De?w.image[Ae].image:w.image[Ae],Oe[Ae]=Yt(w,Oe[Ae]);const rt=Oe[0],je=c.convert(w.format,w.colorSpace),He=c.convert(w.type),pt=P(w.internalFormat,je,He,w.colorSpace),$=w.isVideoTexture!==!0,Ue=ye.__version===void 0||Me===!0,Pe=Re.dataReady;let Ye=H(w,rt);k(s.TEXTURE_CUBE_MAP,w);let Ce;if(nt){$&&Ue&&i.texStorage2D(s.TEXTURE_CUBE_MAP,Ye,pt,rt.width,rt.height);for(let Ae=0;Ae<6;Ae++){Ce=Oe[Ae].mipmaps;for(let Ze=0;Ze<Ce.length;Ze++){const dt=Ce[Ze];w.format!==wi?je!==null?$?Pe&&i.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ae,Ze,0,0,dt.width,dt.height,je,dt.data):i.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ae,Ze,pt,dt.width,dt.height,0,dt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):$?Pe&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ae,Ze,0,0,dt.width,dt.height,je,He,dt.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ae,Ze,pt,dt.width,dt.height,0,je,He,dt.data)}}}else{if(Ce=w.mipmaps,$&&Ue){Ce.length>0&&Ye++;const Ae=kt(Oe[0]);i.texStorage2D(s.TEXTURE_CUBE_MAP,Ye,pt,Ae.width,Ae.height)}for(let Ae=0;Ae<6;Ae++)if(De){$?Pe&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ae,0,0,0,Oe[Ae].width,Oe[Ae].height,je,He,Oe[Ae].data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ae,0,pt,Oe[Ae].width,Oe[Ae].height,0,je,He,Oe[Ae].data);for(let Ze=0;Ze<Ce.length;Ze++){const Ht=Ce[Ze].image[Ae].image;$?Pe&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ae,Ze+1,0,0,Ht.width,Ht.height,je,He,Ht.data):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ae,Ze+1,pt,Ht.width,Ht.height,0,je,He,Ht.data)}}else{$?Pe&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ae,0,0,0,je,He,Oe[Ae]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ae,0,pt,je,He,Oe[Ae]);for(let Ze=0;Ze<Ce.length;Ze++){const dt=Ce[Ze];$?Pe&&i.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ae,Ze+1,0,0,je,He,dt.image[Ae]):i.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Ae,Ze+1,pt,je,He,dt.image[Ae])}}}x(w)&&_(s.TEXTURE_CUBE_MAP),ye.__version=Re.version,w.onUpdate&&w.onUpdate(w)}G.__version=w.version}function te(G,w,fe,Me,Re,ye){const tt=c.convert(fe.format,fe.colorSpace),Le=c.convert(fe.type),Qe=P(fe.internalFormat,tt,Le,fe.colorSpace),nt=a.get(w),De=a.get(fe);if(De.__renderTarget=w,!nt.__hasExternalTextures){const Oe=Math.max(1,w.width>>ye),rt=Math.max(1,w.height>>ye);Re===s.TEXTURE_3D||Re===s.TEXTURE_2D_ARRAY?i.texImage3D(Re,ye,Qe,Oe,rt,w.depth,0,tt,Le,null):i.texImage2D(Re,ye,Qe,Oe,rt,0,tt,Le,null)}i.bindFramebuffer(s.FRAMEBUFFER,G),Fe(w)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,Me,Re,De.__webglTexture,0,_t(w)):(Re===s.TEXTURE_2D||Re>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&Re<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,Me,Re,De.__webglTexture,ye),i.bindFramebuffer(s.FRAMEBUFFER,null)}function oe(G,w,fe){if(s.bindRenderbuffer(s.RENDERBUFFER,G),w.depthBuffer){const Me=w.depthTexture,Re=Me&&Me.isDepthTexture?Me.type:null,ye=C(w.stencilBuffer,Re),tt=w.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Le=_t(w);Fe(w)?d.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Le,ye,w.width,w.height):fe?s.renderbufferStorageMultisample(s.RENDERBUFFER,Le,ye,w.width,w.height):s.renderbufferStorage(s.RENDERBUFFER,ye,w.width,w.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,tt,s.RENDERBUFFER,G)}else{const Me=w.textures;for(let Re=0;Re<Me.length;Re++){const ye=Me[Re],tt=c.convert(ye.format,ye.colorSpace),Le=c.convert(ye.type),Qe=P(ye.internalFormat,tt,Le,ye.colorSpace),nt=_t(w);fe&&Fe(w)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,nt,Qe,w.width,w.height):Fe(w)?d.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,nt,Qe,w.width,w.height):s.renderbufferStorage(s.RENDERBUFFER,Qe,w.width,w.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Ee(G,w){if(w&&w.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(s.FRAMEBUFFER,G),!(w.depthTexture&&w.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Me=a.get(w.depthTexture);Me.__renderTarget=w,(!Me.__webglTexture||w.depthTexture.image.width!==w.width||w.depthTexture.image.height!==w.height)&&(w.depthTexture.image.width=w.width,w.depthTexture.image.height=w.height,w.depthTexture.needsUpdate=!0),ue(w.depthTexture,0);const Re=Me.__webglTexture,ye=_t(w);if(w.depthTexture.format===tl)Fe(w)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Re,0,ye):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Re,0);else if(w.depthTexture.format===nl)Fe(w)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Re,0,ye):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Re,0);else throw new Error("Unknown depthTexture format")}function Ne(G){const w=a.get(G),fe=G.isWebGLCubeRenderTarget===!0;if(w.__boundDepthTexture!==G.depthTexture){const Me=G.depthTexture;if(w.__depthDisposeCallback&&w.__depthDisposeCallback(),Me){const Re=()=>{delete w.__boundDepthTexture,delete w.__depthDisposeCallback,Me.removeEventListener("dispose",Re)};Me.addEventListener("dispose",Re),w.__depthDisposeCallback=Re}w.__boundDepthTexture=Me}if(G.depthTexture&&!w.__autoAllocateDepthBuffer){if(fe)throw new Error("target.depthTexture not supported in Cube render targets");const Me=G.texture.mipmaps;Me&&Me.length>0?Ee(w.__webglFramebuffer[0],G):Ee(w.__webglFramebuffer,G)}else if(fe){w.__webglDepthbuffer=[];for(let Me=0;Me<6;Me++)if(i.bindFramebuffer(s.FRAMEBUFFER,w.__webglFramebuffer[Me]),w.__webglDepthbuffer[Me]===void 0)w.__webglDepthbuffer[Me]=s.createRenderbuffer(),oe(w.__webglDepthbuffer[Me],G,!1);else{const Re=G.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ye=w.__webglDepthbuffer[Me];s.bindRenderbuffer(s.RENDERBUFFER,ye),s.framebufferRenderbuffer(s.FRAMEBUFFER,Re,s.RENDERBUFFER,ye)}}else{const Me=G.texture.mipmaps;if(Me&&Me.length>0?i.bindFramebuffer(s.FRAMEBUFFER,w.__webglFramebuffer[0]):i.bindFramebuffer(s.FRAMEBUFFER,w.__webglFramebuffer),w.__webglDepthbuffer===void 0)w.__webglDepthbuffer=s.createRenderbuffer(),oe(w.__webglDepthbuffer,G,!1);else{const Re=G.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ye=w.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,ye),s.framebufferRenderbuffer(s.FRAMEBUFFER,Re,s.RENDERBUFFER,ye)}}i.bindFramebuffer(s.FRAMEBUFFER,null)}function ke(G,w,fe){const Me=a.get(G);w!==void 0&&te(Me.__webglFramebuffer,G,G.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),fe!==void 0&&Ne(G)}function V(G){const w=G.texture,fe=a.get(G),Me=a.get(w);G.addEventListener("dispose",z);const Re=G.textures,ye=G.isWebGLCubeRenderTarget===!0,tt=Re.length>1;if(tt||(Me.__webglTexture===void 0&&(Me.__webglTexture=s.createTexture()),Me.__version=w.version,f.memory.textures++),ye){fe.__webglFramebuffer=[];for(let Le=0;Le<6;Le++)if(w.mipmaps&&w.mipmaps.length>0){fe.__webglFramebuffer[Le]=[];for(let Qe=0;Qe<w.mipmaps.length;Qe++)fe.__webglFramebuffer[Le][Qe]=s.createFramebuffer()}else fe.__webglFramebuffer[Le]=s.createFramebuffer()}else{if(w.mipmaps&&w.mipmaps.length>0){fe.__webglFramebuffer=[];for(let Le=0;Le<w.mipmaps.length;Le++)fe.__webglFramebuffer[Le]=s.createFramebuffer()}else fe.__webglFramebuffer=s.createFramebuffer();if(tt)for(let Le=0,Qe=Re.length;Le<Qe;Le++){const nt=a.get(Re[Le]);nt.__webglTexture===void 0&&(nt.__webglTexture=s.createTexture(),f.memory.textures++)}if(G.samples>0&&Fe(G)===!1){fe.__webglMultisampledFramebuffer=s.createFramebuffer(),fe.__webglColorRenderbuffer=[],i.bindFramebuffer(s.FRAMEBUFFER,fe.__webglMultisampledFramebuffer);for(let Le=0;Le<Re.length;Le++){const Qe=Re[Le];fe.__webglColorRenderbuffer[Le]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,fe.__webglColorRenderbuffer[Le]);const nt=c.convert(Qe.format,Qe.colorSpace),De=c.convert(Qe.type),Oe=P(Qe.internalFormat,nt,De,Qe.colorSpace,G.isXRRenderTarget===!0),rt=_t(G);s.renderbufferStorageMultisample(s.RENDERBUFFER,rt,Oe,G.width,G.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Le,s.RENDERBUFFER,fe.__webglColorRenderbuffer[Le])}s.bindRenderbuffer(s.RENDERBUFFER,null),G.depthBuffer&&(fe.__webglDepthRenderbuffer=s.createRenderbuffer(),oe(fe.__webglDepthRenderbuffer,G,!0)),i.bindFramebuffer(s.FRAMEBUFFER,null)}}if(ye){i.bindTexture(s.TEXTURE_CUBE_MAP,Me.__webglTexture),k(s.TEXTURE_CUBE_MAP,w);for(let Le=0;Le<6;Le++)if(w.mipmaps&&w.mipmaps.length>0)for(let Qe=0;Qe<w.mipmaps.length;Qe++)te(fe.__webglFramebuffer[Le][Qe],G,w,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,Qe);else te(fe.__webglFramebuffer[Le],G,w,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Le,0);x(w)&&_(s.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(tt){for(let Le=0,Qe=Re.length;Le<Qe;Le++){const nt=Re[Le],De=a.get(nt);let Oe=s.TEXTURE_2D;(G.isWebGL3DRenderTarget||G.isWebGLArrayRenderTarget)&&(Oe=G.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(Oe,De.__webglTexture),k(Oe,nt),te(fe.__webglFramebuffer,G,nt,s.COLOR_ATTACHMENT0+Le,Oe,0),x(nt)&&_(Oe)}i.unbindTexture()}else{let Le=s.TEXTURE_2D;if((G.isWebGL3DRenderTarget||G.isWebGLArrayRenderTarget)&&(Le=G.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),i.bindTexture(Le,Me.__webglTexture),k(Le,w),w.mipmaps&&w.mipmaps.length>0)for(let Qe=0;Qe<w.mipmaps.length;Qe++)te(fe.__webglFramebuffer[Qe],G,w,s.COLOR_ATTACHMENT0,Le,Qe);else te(fe.__webglFramebuffer,G,w,s.COLOR_ATTACHMENT0,Le,0);x(w)&&_(Le),i.unbindTexture()}G.depthBuffer&&Ne(G)}function Ie(G){const w=G.textures;for(let fe=0,Me=w.length;fe<Me;fe++){const Re=w[fe];if(x(Re)){const ye=O(G),tt=a.get(Re).__webglTexture;i.bindTexture(ye,tt),_(ye),i.unbindTexture()}}}const Be=[],Xe=[];function ze(G){if(G.samples>0){if(Fe(G)===!1){const w=G.textures,fe=G.width,Me=G.height;let Re=s.COLOR_BUFFER_BIT;const ye=G.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,tt=a.get(G),Le=w.length>1;if(Le)for(let nt=0;nt<w.length;nt++)i.bindFramebuffer(s.FRAMEBUFFER,tt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+nt,s.RENDERBUFFER,null),i.bindFramebuffer(s.FRAMEBUFFER,tt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+nt,s.TEXTURE_2D,null,0);i.bindFramebuffer(s.READ_FRAMEBUFFER,tt.__webglMultisampledFramebuffer);const Qe=G.texture.mipmaps;Qe&&Qe.length>0?i.bindFramebuffer(s.DRAW_FRAMEBUFFER,tt.__webglFramebuffer[0]):i.bindFramebuffer(s.DRAW_FRAMEBUFFER,tt.__webglFramebuffer);for(let nt=0;nt<w.length;nt++){if(G.resolveDepthBuffer&&(G.depthBuffer&&(Re|=s.DEPTH_BUFFER_BIT),G.stencilBuffer&&G.resolveStencilBuffer&&(Re|=s.STENCIL_BUFFER_BIT)),Le){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,tt.__webglColorRenderbuffer[nt]);const De=a.get(w[nt]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,De,0)}s.blitFramebuffer(0,0,fe,Me,0,0,fe,Me,Re,s.NEAREST),p===!0&&(Be.length=0,Xe.length=0,Be.push(s.COLOR_ATTACHMENT0+nt),G.depthBuffer&&G.resolveDepthBuffer===!1&&(Be.push(ye),Xe.push(ye),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,Xe)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Be))}if(i.bindFramebuffer(s.READ_FRAMEBUFFER,null),i.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),Le)for(let nt=0;nt<w.length;nt++){i.bindFramebuffer(s.FRAMEBUFFER,tt.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+nt,s.RENDERBUFFER,tt.__webglColorRenderbuffer[nt]);const De=a.get(w[nt]).__webglTexture;i.bindFramebuffer(s.FRAMEBUFFER,tt.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+nt,s.TEXTURE_2D,De,0)}i.bindFramebuffer(s.DRAW_FRAMEBUFFER,tt.__webglMultisampledFramebuffer)}else if(G.depthBuffer&&G.resolveDepthBuffer===!1&&p){const w=G.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[w])}}}function _t(G){return Math.min(l.maxSamples,G.samples)}function Fe(G){const w=a.get(G);return G.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&w.__useRenderToTexture!==!1}function at(G){const w=f.render.frame;g.get(G)!==w&&(g.set(G,w),G.update())}function Yt(G,w){const fe=G.colorSpace,Me=G.format,Re=G.type;return G.isCompressedTexture===!0||G.isVideoTexture===!0||fe!==Vs&&fe!==Ja&&(Pt.getTransfer(fe)===qt?(Me!==wi||Re!==Gi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",fe)),w}function kt(G){return typeof HTMLImageElement<"u"&&G instanceof HTMLImageElement?(m.width=G.naturalWidth||G.width,m.height=G.naturalHeight||G.height):typeof VideoFrame<"u"&&G instanceof VideoFrame?(m.width=G.displayWidth,m.height=G.displayHeight):(m.width=G.width,m.height=G.height),m}this.allocateTextureUnit=ce,this.resetTextureUnits=re,this.setTexture2D=ue,this.setTexture2DArray=F,this.setTexture3D=Q,this.setTextureCube=J,this.rebindTextures=ke,this.setupRenderTarget=V,this.updateRenderTargetMipmap=Ie,this.updateMultisampleRenderTarget=ze,this.setupDepthRenderbuffer=Ne,this.setupFrameBufferTexture=te,this.useMultisampledRTT=Fe}function rR(s,e){function i(a,l=Ja){let c;const f=Pt.getTransfer(l);if(a===Gi)return s.UNSIGNED_BYTE;if(a===dp)return s.UNSIGNED_SHORT_4_4_4_4;if(a===hp)return s.UNSIGNED_SHORT_5_5_5_1;if(a===B_)return s.UNSIGNED_INT_5_9_9_9_REV;if(a===z_)return s.UNSIGNED_INT_10F_11F_11F_REV;if(a===P_)return s.BYTE;if(a===I_)return s.SHORT;if(a===$o)return s.UNSIGNED_SHORT;if(a===fp)return s.INT;if(a===Pr)return s.UNSIGNED_INT;if(a===ma)return s.FLOAT;if(a===ll)return s.HALF_FLOAT;if(a===F_)return s.ALPHA;if(a===H_)return s.RGB;if(a===wi)return s.RGBA;if(a===tl)return s.DEPTH_COMPONENT;if(a===nl)return s.DEPTH_STENCIL;if(a===G_)return s.RED;if(a===pp)return s.RED_INTEGER;if(a===V_)return s.RG;if(a===mp)return s.RG_INTEGER;if(a===gp)return s.RGBA_INTEGER;if(a===Jc||a===$c||a===eu||a===tu)if(f===qt)if(c=e.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(a===Jc)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(a===$c)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(a===eu)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(a===tu)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=e.get("WEBGL_compressed_texture_s3tc"),c!==null){if(a===Jc)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(a===$c)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===eu)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===tu)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(a===wh||a===Rh||a===Ch||a===Dh)if(c=e.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(a===wh)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(a===Rh)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(a===Ch)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(a===Dh)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(a===Nh||a===Uh||a===Lh)if(c=e.get("WEBGL_compressed_texture_etc"),c!==null){if(a===Nh||a===Uh)return f===qt?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(a===Lh)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(a===Oh||a===Ph||a===Ih||a===Bh||a===zh||a===Fh||a===Hh||a===Gh||a===Vh||a===kh||a===Wh||a===Xh||a===jh||a===qh)if(c=e.get("WEBGL_compressed_texture_astc"),c!==null){if(a===Oh)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(a===Ph)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(a===Ih)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(a===Bh)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(a===zh)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(a===Fh)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(a===Hh)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(a===Gh)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(a===Vh)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(a===kh)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(a===Wh)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(a===Xh)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(a===jh)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(a===qh)return f===qt?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(a===Yh||a===Zh||a===Kh)if(c=e.get("EXT_texture_compression_bptc"),c!==null){if(a===Yh)return f===qt?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(a===Zh)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(a===Kh)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(a===Qh||a===Jh||a===$h||a===ep)if(c=e.get("EXT_texture_compression_rgtc"),c!==null){if(a===Qh)return c.COMPRESSED_RED_RGTC1_EXT;if(a===Jh)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(a===$h)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(a===ep)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return a===el?s.UNSIGNED_INT_24_8:s[a]!==void 0?s[a]:null}return{convert:i}}const sR=`
void main() {
