...
`)+`
`+_);const P=O+x+f,R=O+_+d,H=a_(l,l.VERTEX_SHADER,P),X=a_(l,l.FRAGMENT_SHADER,R);l.attachShader(A,H),l.attachShader(A,X),i.index0AttributeName!==void 0?l.bindAttribLocation(A,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(A,0,"position"),l.linkProgram(A);function B(Y){if(s.debug.checkShaderErrors){const re=l.getProgramInfoLog(A)||"",ce=l.getShaderInfoLog(H)||"",xe=l.getShaderInfoLog(X)||"",ue=re.trim(),F=ce.trim(),Q=xe.trim();let J=!0,W=!0;if(l.getProgramParameter(A,l.LINK_STATUS)===!1)if(J=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,A,H,X);else{const N=s_(l,H,"vertex"),M=s_(l,X,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(A,l.VALIDATE_STATUS)+`
